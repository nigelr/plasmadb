...
=== Usage Examples
==== Retrieve
* <b><tt>Doc.retrieve :all</b></tt>  => retrieves these documents
...
* <b><tt>Doc.search "superman", :fields=>:user_name</b></tt>  => Returns an array of document ids with exact match for "superman" in fileds named "user_name"
